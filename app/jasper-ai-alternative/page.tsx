...
export default function FeaturesPage() {
  return (
    ...
    <div className="pt-[130px] flex flex-col items-center">
        <h1 className="text-[56px] text-center">Jasper.ai Alternative</h1>
        <p className="text-[20px] text-center text-[#929293] pt-4 pb-24">See why Zoo AI is the best alternative to Jasper.ai</p>
