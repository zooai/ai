...
export default function FeaturesPage() {
  return (
    ...
    <div className="pt-[130px] flex flex-col">
        <h1 className="text-[56px] max-md:text-[44px] text-center w-full max-md:px-4">Copy.ai Alternative</h1>
        <p className="text-[20px] text-center w-full max-md:px-4 text-[#929293] pt-4 pb-24">See why Zoo AI is the best alternative to Copy.ai</p>
        <div className="w-full bg-[#222] py-24 px-8">
            <div className="w-full m-auto max-w-[950px] flex flex-col text-[18px] articles">
                <p className="text-[1.8rem]">
                    <span>You&apos;re looking for an alternative to&nbsp;</span><Link target="_blank" href='https://www.copy.ai/'>Copy.ai</Link>
                </p>
