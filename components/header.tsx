    ...
    <nav className={`${isOpen ? 'fixed' : 'absolute'} max-md:fixed w-full bg-transparent z-10 max-md:bg-black`}>
      <div className="px-4 sm:px-6 lg:px-8 xl:px-12 ">
        <div className="flex items-center justify-between h-20 max-md:flex-row-reverse">
          ...
          {authuser ?
            <Button onClick={handleLogout} className="text-white max-md:hidden bg-transparent border border-white hover:text-black hover:bg-white px-3 py-2 rounded-full text-xs md:block mr-3">
              Logout
            </Button> :
