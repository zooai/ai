        ...
        <div className={`absolute transition-all duration-300 ${
            ...
            <div className="flex flex-col h-screen">
                ...
                <div className='flex flex-col overflow-auto'>
                    <h2 className="border-b-2 py-3 px-5 border-white text-xl">Settings</h2>
                    <p className="pt-6 pl-5 text-xs">Sense of humor</p>
                    <div className="px-5">
                        <CustomSlider valueLabelDisplay="auto" aria-label="sense slider" defaultValue={35} />
                    </div>
                    <p className="pt-2 pl-5 text-xs">Factual</p>
                    <div className="px-5">
                        <CustomSlider valueLabelDisplay="auto" aria-label="factual slider" defaultValue={45} />
                    </div>
                    <p className="pt-2 pl-5 text-xs">Age of Personality</p>
                    <div className="px-5">
                        <CustomSlider valueLabelDisplay="off" aria-label="age slider" defaultValue={55} />
                    </div>
                    ...
                    <div className="mt-6 p-4 border-y border-white">
                        ...
                        <p className="text-[0.7rem] pt-2">
                            Save new chats on this browser to your history and allow them to be used to imporve our models. Unsaved chats will be deleted from our systems within 30 days. This setting does not sync across browsers or devices. <u>Learn more</u>
                        </p>
                    </div>
                    ...
                    <div className="p-4 ">
                        <div className="flex justify-between items-center cursor-pointer" onClick={signOut}>
                            <div className="flex items-center space-x-2">
                                <FaSignOutAlt />
