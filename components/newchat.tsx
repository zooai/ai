    ...
    return (
        <div className={`absolute transition-all duration-300 ${
            ...
            <div className="flex flex-col h-screen">
                <h1 className="absolute w-full z-10 text-3xl pt-12 h-[180px] text-center pb-12 border-b-2 border-white">Pick an animal to start a new AI buddy chat</h1>
                <div className='absolute top-0 left-0 z-10 cursor-pointer pl-4 pt-4' onClick={()=>event(0)}><FaArrowLeft /></div>
                <Sideslider />
                <div className='flex flex-col overflow-auto'>
                    <h2 className="border-b-2 py-3 px-5 border-white text-xl">Browser Buddies</h2>
                    ...
                    <div className="flex justify-between items-center border-y-2 py-3 px-5 border-white text-xl">
                        ...
                        <div className='cursor-pointer' onClick={()=>setHide(!hide)}>{hide ? <FaAngleUp />: <FaAngleDown />}</div>
                    </div>
                    ...
                    <div className='flex space-x-4 py-8 px-4 text-xs justify-between'>
                        <button className='border border-white px-4 py-2'>Type Buddy Name</button>
                        <button className='border border-white bg-white text-black px-4 py-2'>Start Buddy Chat</button>
                    </div>
                </div>
            </div>
        </div>
