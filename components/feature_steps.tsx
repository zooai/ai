        ...
        <div className="w-1/2 max-md:w-full flex flex-col justify-between gap-8">
          ...
          <div className="flex space-x-4 items-start">
            <div className="text-center bg-[length:100%_100%] bg-[url('../public/bg_mark.png')]">
              <p className="w-[40px] h-[40px] leading-[40px]">1</p>
            </div>
            <div className="flex flex-col space-y-4">
              <p
                className="text-xl font-semibold"
                dangerouslySetInnerHTML={{ __html: step1 ? step1 : '' }}
              ></p>
          ...
          <div className="flex space-x-4 items-start">
            <div className="text-center bg-[length:100%_100%] bg-[url('../public/bg_mark.png')]">
              <p className="w-[40px] h-[40px] leading-[40px]">2</p>
            </div>
            <div className="flex flex-col space-y-4">
              <p
                className="text-xl font-semibold"
                dangerouslySetInnerHTML={{ __html: step2 ? step2 : '' }}
              ></p>
          ...
          <div className="flex space-x-4 items-start">
            <div className="text-center bg-[length:100%_100%] bg-[url('../public/bg_mark.png')]">
              <p className="w-[40px] h-[40px] leading-[40px]">3</p>
            </div>
            <div className="flex flex-col space-y-4">
              <p
                className="text-xl font-semibold"
                dangerouslySetInnerHTML={{ __html: step3 ? step3 : '' }}
              ></p>
