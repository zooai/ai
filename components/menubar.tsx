  ...
  return (
    <div className="flex flex-col justify-between min-h-screen overflow-auto">
      <div className="flex-col">
        ...
        <div
          className="flex items-center border-y-2 py-3 px-5 border-white cursor-pointer space-x-8"
          onClick={() => setFlag(1)}
        >
          <FaPlus />
        ...
        <div
          className="flex items-center border-b-2 py-3 px-5 border-white cursor-pointer space-x-8"
          onClick={() => setFlag(2)}
        >
          <FaHistory />
      ...
      <div className="flex items-center justify-center space-x-2 pb-8 text-2xl">
        <Link href="https://twitter.com/zoo_labs" legacyBehavior>
          <FaTwitter />
        </Link>
        <Link href="https://t.me/zooofficial" legacyBehavior>
          <FaTelegram />
        </Link>
        <Link href="https://instagram.com/zoolabs.io" legacyBehavior>
          <FaInstagram />
        </Link>
        <Link href="https://discord.gg/AqrYhChx5b" legacyBehavior>
          <FaDiscord />
        </Link>
        <Link href="https://zoolabsofficial.medium.com" legacyBehavior>
          <BsMedium />
        </Link>
        <Link href="https://youtu.be/6yYuYtMWgOU" legacyBehavior>
          <FaYoutube />
        </Link>
      </div>
