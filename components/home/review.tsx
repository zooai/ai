...
function Review() {
  const contents = [
    {
      ...
      content:
        "It's an all-in-one tool, I can create text and images in int, and it helps a lot to save time, not needing more than one tool to create an article or post for...",
      company: trustpilot,
      name: 'Lincoin',
      avatar: avatar1
    },
    {
      ...
      content:
        'I have tested more than two hundred AI platforms but your app is something awesome, it is an another level, really.',
      company: feedback,
      name: 'RAM',
      avatar: avatar2
    },
    {
      ...
      content:
        'Zoo AI is a fantastic AI solution for companies wishing to automate procedures. Then user-friendly interface makes it simple to use, and the sophisticated algorithms are built...',
      company: producthunt,
      name: 'Deldoogh',
      avatar: avatar3
    },
    ...
    },
    {
      ...
      content:
        "Zoo AI has revolutionized my linkedin ad writing process. With Zoo AI's automated features, I'm confident that my ads are performing at their best and ...",
      company: trustpilot,
      name: 'Linnea',
      avatar: avatar5
    },
    ...
    },
    {
      ...
      content:
        "Zoo Ai's rephrasing and rewording tool is awesome! I've only been using it for a short while, but can already tell that it is worth the money. It quickly turns old data into...",
      company: trustpilot,
      name: 'AM',
      avatar: avatar9
    }
  ...
  return (
    <div className="bg-black p-32 max-md:py-24 max-md:px-8">
      <p className="text-5xl max-md:text-3xl font-semibold text-center">
        Don’t Take Our Word For It
      </p>
      <p className="text-xl mt-4 text-center font-semibold text-[#8787F7]">
        Hear what our customers say and why they love us.{' '}
      </p>
