      ...
      <div className="flex max-md:flex-col items-center justify-between">
        <div className="w-2/5 max-md:w-full flex flex-col gap-4 pr-16 max-md:px-16 max-sm:px-8">
          <p className="text-xs text-[#8d8d8e]">
            Hours lost per week on distractions, context-switching, manual
            writing work, and automating repetitive tasks.
          </p>
          ...
          <p className="text-xs">
            How much is 1 hour of your time worth to you?
          </p>
        ...
        <div className="w-3/5 max-md:w-full flex flex-col items-center border-l pl-16 max-md:border-none max-md:px-16 max-md:pt-16 max-sm:px-8">
          <div className="text-3xl max-md:text-center font-semibold ">
            <span className="text-[#8787f7]">Return</span> on investment
          </div>
          <div className="text-sm">Per month with ZOO AI</div>
          <div className="text-5xl pt-5 flex items-center justify-center">
            <span className="font-semibold">
              ${hour.values[0] * 4 * rate - 49}
            </span>
            <Image
              className="h-[50px]"
              src={money_icon}
          ...
          <div className="text-sm">
            Or {hour.values[0] * 4} hours of your life
          </div>
          <Link className="w-full" href="/sign-up">
            <div className="w-full mt-5 bg-[#8787f7] text-white py-2 rounded-lg flex items-center justify-center gap-4">
              Get Started Now <FaAngleRight />
            </div>
          </Link>
          ...
          <div className="flex justify-between items-center w-full pt-2">
            ...
            <span className="text-white text-xs">
              {hour.values[0] * 4} hours
            </span>
          </div>
          <div className="flex justify-between items-center w-full pt-2">
            <span className="text-[#9a9a9b] text-xs">
              Value of ZOO AI for saving {hour.values[0] * 4} hours of your time{' '}
            </span>
            <span className="text-white text-xs">
              ${hour.values[0] * 4 * rate}
            </span>
          </div>
          <div className="flex justify-between items-center w-full pt-2">
            <span className="text-[#9a9a9b] text-xs">
              Cost of ZOO AI PRO subscription per month
            </span>
