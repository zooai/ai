...
function Create() {
    return (
      <div className='bg-black py-32 max-md:py-24'>
        <p className='text-5xl max-md:text-3xl text-center'>Create <span className='text-[#8787F7]'>Content</span> at lightning speeds.</p>
        <div className='flex max-md:flex-col px-36 max-md:px-8 pt-32 max-md:pt-16 items-center justify-between'>
            ...
            <div className='space-y-4 w-1/2 ml-16 max-md:w-full max-md:ml-0 max-md:pt-8'>
                <p className='text-3xl max-md:text-2xl max-md:text-center'>Jumpstart creativity and banish <span className='text-[#8787F7]'>writers block.</span></p>
        ...
        <div className='flex max-md:flex-col px-36 max-md:px-8 pt-32 max-md:pt-16 items-center justify-between'>
            ...
            <div className='space-y-4 w-1/2 ml-16 max-md:w-full max-md:ml-0 max-md:pt-8'>
                <p className='text-3xl max-md:text-2xl max-md:text-center'>Get the Job done with a <span className='text-[#8787F7]'>smile</span> and endearing charm.</p>
                <p className='text-xs max-md:text-center'>Use the Zoo AI buddies to reduce your work by up to 40% and spend more time building and scaling.</p>
            </div>
        </div>
      </div>
    );
