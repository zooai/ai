  ...
  const contents = [
    {
      ...
      content:
        'You will be charged the number of words the output contains. The number of words in our plans is the number of words you can generate in a month timeframe. If you choose a yearly plan, you will be able to generate the number of words you choose on a monthly basis and your word credits will reset every month.'
    },
    {
    ...
    },
    {
      ...
      content:
        'You can either choose to subscribe to a plan or to make one-time purchases.'
    },
    {
      title: 'What is the commitment period?',
      content:
        'There is no commitment period and you can cancel your subscription at any time.'
    },
    {
      title: 'Can I write a long-form blog article (1,000+ words) with ZooAI?',
      content:
        'Absolutely! The new Long Form Blog writer lets you generate long articles. You can also use any of our blog post tools to generate the blog elements you need: titles, intros, outlines, or paragraphs.'
    },
    {
    ...
    },
    {
      ...
      content:
        'Using Zoo would help you to supercharge your content production by writing long articles in minutes, not hours. We estimate that it takes about 2 min to write a long-form article.'
    },
    {
    ...
    },
    {
      ...
      content:
        'Content marketing can help you expand your organic reach by writing blog articles. Zoo AI lets you write unlimited quality content that ranks, combine this with the right keyword research and you will dominate your niche in no time.'
    },
    {
    ...
    },
    {
      ...
      content:
        'Zoo AI is using the worlds most smartest AI that allows you to write a 1,000+ words from just a title and keyword in seconds, without compromising the price. In terms of pricing, our Pro plan is the most generous on the market. It lets you generate unlimited words each month, which would cost you $1000+ a month with any other tool.'
    },
    {
