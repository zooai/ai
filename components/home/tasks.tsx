...
function Tasks() {
    return (
      <div className='bg-black p-32 max-md:py-24 max-md:px-0'>
        <p className='text-5xl max-md:text-3xl text-center'>Avoid the fatigue from <span className='text-[#8787F7]'>repetitive tasks</span><br />when you streamline with Zoo Ai.</p>
        <div className='flex px-8 pt-32 max-md:pt-16 max-md:flex-col-reverse items-start justify-between gap-32'>
            <div className='w-1/2 max-md:w-full ml-16 max-md:ml-0 max-md:z-10 justify-between flex flex-col items-center max-md:bg-gradient-to-b from-[#00000000] via-[#000000cf] to-[#000000]'>
                <div className='w-[1px] h-[150px] bg-[#929292]'></div>
                <div className='flex flex-col py-8 space-y-4'>
                    <p className='text-3xl px-16 max-sm:px-4 text-center'>A <span className='text-[#8787F7]'>friendly AI</span> for all</p>
        ...
        <div className='flex px-8 pt-32 max-md:pt-16 max-md:flex-col items-start justify-between gap-32'>
            ...
            <div className='w-1/2 max-md:w-full ml-16 max-md:ml-0 max-md:z-10 justify-between flex flex-col items-center max-md:bg-gradient-to-b from-[#00000000] via-[#000000cf] to-[#000000]'>
                <div className='w-[1px] h-[150px] bg-[#929292]'></div>
                <div className='flex flex-col py-8 space-y-4'>
                    <p className='text-3xl px-16 max-sm:px-4 text-center'>AI that keeps working in the background</p>
        ...
        <div className='flex px-8 pt-32 max-md:pt-16 max-md:flex-col-reverse items-start justify-between gap-32'>
            <div className='w-1/2 max-md:w-full ml-16 max-md:ml-0 max-md:z-10 justify-between flex flex-col items-center max-md:bg-gradient-to-b from-[#00000000] via-[#000000cf] to-[#000000]'>
                <div className='w-[1px] h-[150px] bg-[#929292]'></div>
                <div className='flex flex-col py-8 space-y-4'>
                    <p className='text-3xl px-16 max-sm:px-4 text-center'>All access <span className='text-[#8787F7]'>all the time</span></p>
        ...
        <div className='flex px-8 pt-32 max-md:pt-16 max-md:flex-col items-start justify-between gap-32'>
            ...
            <div className='w-1/2 max-md:w-full ml-16 max-md:ml-0 max-md:z-10 justify-between flex flex-col items-center max-md:bg-gradient-to-b from-[#00000000] via-[#000000cf] to-[#000000]'>
                <div className='w-[1px] h-[150px] bg-[#929292]'></div>
                <div className='flex flex-col py-8 space-y-4'>
                    <p className='text-3xl px-16 max-sm:px-4 text-center'>Your virtual assistant</p>
