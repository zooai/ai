            ...
            <div className='sticky top-0 w-1/2 pr-24 max-md:w-full max-md:p-0'>
                <div className='flex flex-col gap-8 pt-8'>
                {
                    contents.map((data, index) => (
                        <div className='bg-gradient-to-l rounded-xl text-center text-5xl text-[#8787f7] from-[#1D1D57] to-[#05060C] border border-[#929293] w-full py-8 max-md:py-4 max-md:text-3xl'>
                            {data.title}
                        </div>
                    ))
                }
