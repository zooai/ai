...
function Solution() {
    return (
      <div className='bg-black py-32'>
        ...
        <div className='flex px-36 pt-32 items-start justify-between'>
            <div className='space-y-4 w-1/2 mr-16 flex flex-col justify-between items-center'>
                ...
                <div className='w-[1px] h-[600px] bg-[#929292]'></div>
            </div>
            <div className='sticky top-0 flex flex-col gap-12 w-1/2 ml-16'>
        ...
        <div className='flex px-36 pt-36 items-start justify-between'>
            <div className='sticky top-0 w-1/2 pr-24'>
                <Image
                    className='w-full'
                    src={gpt4}
                    width='1000'
            ...
            <div className='space-y-4 w-1/2 flex flex-col justify-between items-center'>
                ...
                <div className='w-[1px] h-[1000px] bg-[#929292]'></div>
            </div>
        </div>
