  ...
  const plans = [
    {
      ...
      list: [
        ...
        {
          value:
            'Food ordering, business tools, recording + transcribing, lifestyle support, and so much more!'
        }
      ]
    },
    {
      ...
      <div className="flex space-x-32 items-start justify-between max-md:flex-col max-md:space-x-0">
        <div className="w-1/2 max-w-[380px] flex flex-col space-y-4 max-md:w-full max-md:m-auto">
          ...
          <div className="flex justify-between items-center">
            <p className="text-sm text-[#8787f7]">
              Loved by AI pioneers globally
            </p>
          ...
          <div
            className={`cursor-pointer px-4 py-2 rounded-md flex items-center gap-4 justify-between ${
              plan.index == 0
                ? 'bg-gradient-to-l from-[#1D1D57] to-[#05060C]'
                : 'border border-black hover:border-gray-100 '
            }`}
            onClick={() => {
              setPlan(plans[0])
            }}
          >
            <div className="flex flex-col gap-2">
              ...
              <p
                className={`text-xs ${
                  plan.index == 0 ? 'text-[#8C8CD7]' : 'text-[#929292]'
                }`}
              >
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <p
                className={`text-xs ${
                  plan.index == 1 ? 'text-[#8C8CD7]' : 'text-[#929292]'
                }`}
              >
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <p
                className={`text-xs ${
                  plan.index == 2 ? 'text-[#8C8CD7]' : 'text-[#929292]'
                }`}
              >
                Buy individual word and image credits.
              </p>
            </div>
            <FaAngleRight />
          </div>
        ...
        <div className="w-1/2 flex flex-col space-y-4 items-center max-md:w-full max-md:pt-16">
          <div className="flex justify-center items-center space-x-2">
            ...
            <div className="bg-[#0A1625] text-white px-4 py-1 text-xs rounded-full">
              3 Months Free
            </div>
          </div>
          ...
          <div className="flex flex-col w-full max-w-[410px] rounded-xl bg-gradient-to-r from-[#1D1D57] to-[#05060C] pb-4">
            <div className="rounded-t-xl flex flex-col px-8 py-8 gap-4 bg-gradient-to-l from-[#7878db] to-[#252534]">
              ...
              <div className="flex gap-2 items-center">
                ...
                {plan.index != 2 ? (
                  <p className="text-[#929293] text-xl">/month</p>
                ) : (
                  ''
                )}
              </div>
              ...
              <Link className="w-full" href="/sign-up">
                <div className="w-full bg-[#8787F7] rounded-lg py-2 cursor-pointer flex space-x-2 items-center justify-center">
                  <span>Choose Plan</span> <FaAngleRight />
                </div>
              </Link>
            </div>
          ...
          <p className="text-center text-xs pt-4">
            ...
            <br />
            *Plans with unlimited memory and tokens are subject to our{' '}
            <span className="text-[#8787f7]">Fair Use Policy.</span>
          </p>
        </div>
      </div>
    </div>
